...
import { HideButtonSpinnerAction, HideLoaderAction, ResetLoaderStateAction, ShowButtonSpinnerAction, ShowLoaderAction } from '../action/loader.action';
...
export class LoaderState {
  ...
  public resetLoaderStateAction(ctx: StateContext<LoaderStateModel>) {
    ctx.patchState({
      status: false,
      loadingCount: 0,
      button_spinner: false,
